  ...
  return <section className="py-20 bg-gradient-subtle">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-lg md:text-xl text-muted-foreground max-w-3xl mx-auto">Von der kompletten Entrümpelung bis zum professionellen Umzug – wir sind Ihr zuverlässiger Partner in NRW und Umgebung.</p>
        </div>
        
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service, index) => <Card key={index} className="hover:shadow-card transition-all duration-300 transform hover:scale-105 border-0 shadow-lg">

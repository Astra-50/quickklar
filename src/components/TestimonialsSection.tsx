  ...
  return <section className="py-20 bg-background">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-lg md:text-xl text-muted-foreground max-w-3xl mx-auto">Vertrauen Sie auf die Erfahrungen von über 500 zufriedenen Kunden aus NRW und Umgebung.</p>
        </div>
        
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {testimonials.map((testimonial, index) => <Card key={index} className="hover:shadow-card transition-all duration-300 border-0 shadow-lg relative">
              <CardContent className="p-8">
                ...
                <div className="border-t pt-4">
                  ...
                  {testimonial.language === "en" && <span className="inline-block mt-2 px-2 py-1 bg-blue-100 text-blue-800 text-xs rounded-full">
                      English Review
                    </span>}
                </div>
              </CardContent>
